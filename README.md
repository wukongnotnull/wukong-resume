...
同一份内容，同时生成给人看的精美网站或者 PDF 或者 Word 。
...
| 特性 | 说明 |
|------|------|
| 🎨 **6种预设风格** | 科技风、创意风、商务风、金融风、学术风、文艺风 |
| 🇨🇳 **中英文双语** | 自动切换语言、纸张、文案 |
| 📱 **2种模板** | 单栏简约版、双栏侧边栏版 |
...
| 风格 | 适用岗位 | 特点 |
|------|---------|------|
| **科技风** (tech) | 程序员、工程师、数据分析师 | 蓝色系，现代科技感 |
| **创意风** (creative) | UI/UX设计师、创意总监 | 紫色系，大胆创意 |
| **商务风** (business) | 项目经理、企业高管 | 深蓝黑，专业稳重 |
| **金融风** (finance) | 金融分析师、咨询顾问 | 绿金色，高端精致 |
| **学术风** (academic) | 研究员、教师、教授 | 深灰色，简洁严谨 |
| **文艺风** (literary) | 作家、编辑、记者、文案 | 米黄棕，书卷气 |
